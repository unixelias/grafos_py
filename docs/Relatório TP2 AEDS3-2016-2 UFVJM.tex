...
%\usepackage{nomencl.cwl} 			% Lista de simbolos
...
\usepackage[alf]{/usr/local/share/texmf/tex/latex/abntex2/abntex2cite}
...
% ---
\titulo{TP3 - Implementação de Algoritmos com Grafos}
\autor{Elias da Cunha Alves\thanks{elias.alves@ufvjm.edu.br}\and Fulano de Tal
...
\hypersetup{
	...
	pdftitle={\@title}, 
	pdfauthor={\@author},
	pdfsubject={Implementação de Grafos em Python},
	pdfcreator={LaTeX with abnTeX2},
	pdfkeywords={grafos}{busca em largura}{busca em profundidade}{árvore mínima geradora}{caminho mínimo}{aeds3}, 
